...
gnupod_convert_FLAC.pl - Convert from format X to iPod supported formats.

=head1 SYNOPSIS

B<gnupod_convert_FLAC.pl> FILE FORMATSELECTOR QUALITY

=head1 DESCRIPTION

gnupod_convert_FLAC.pl converts from file format X to one of the formats
