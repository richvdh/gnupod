...
gnupod_convert_RIFF.pl - Convert from format X to iPod supported formats.

=head1 SYNOPSIS

B<gnupod_convert_RIFF.pl> FILE FORMATSELECTOR QUALITY

=head1 DESCRIPTION

gnupod_convert_RIFF.pl converts from file format X to one of the formats
