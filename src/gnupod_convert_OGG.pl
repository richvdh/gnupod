...
gnupod_convert_OGG.pl - Convert from format X to iPod supported formats.

=head1 SYNOPSIS

B<gnupod_convert_OGG.pl> FILE FORMATSELECTOR QUALITY

=head1 DESCRIPTION

gnupod_convert_OGG.pl converts from file format X to one of the formats
